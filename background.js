chrome.action.onClicked.addListener(function(tab) {
  chrome.scripting.executeScript({
    ...
    files: [
      ...
      'src/components/init_reset_icon.js',
      'src/components/init_checkbox.js',
      'src/components/init_add_copy_to_clipboard_button.js',
      'src/components/init_copy_klasses_to_clipboard.js',
      'src/components/init_copy_button_state.js',
      'src/components/init_hover_state.js',
